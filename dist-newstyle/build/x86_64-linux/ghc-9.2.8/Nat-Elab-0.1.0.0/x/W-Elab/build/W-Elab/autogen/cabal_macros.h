...
/* package Nat-Elab-0.1.0.0 */
#ifndef VERSION_Nat_Elab
#define VERSION_Nat_Elab "0.1.0.0"
#endif /* VERSION_Nat_Elab */
#ifndef MIN_VERSION_Nat_Elab
#define MIN_VERSION_Nat_Elab(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Nat_Elab */
...
#define CURRENT_COMPONENT_ID "Nat-Elab-0.1.0.0-inplace-W-Elab"
